...
fileprivate class _JSONEncoder : Encoder {
    ...
    fileprivate let options: JSONModelEncoder._Options
    ...
    fileprivate init(options: JSONModelEncoder._Options, codingPath: [CodingKey] = []) {
...
fileprivate class _JSONDecoder : Decoder {
    ...
    fileprivate let options: JSONModelDecoder._Options
    ...
    fileprivate init(referencing container: Any, at codingPath: [CodingKey] = [], options: JSONModelDecoder._Options) {
